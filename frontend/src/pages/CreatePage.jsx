...
const CreatePage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await api.post("/diary/migranes/new", formData);
      toast.success("Migraine entry created successfully!");
      navigate("/");
    } catch (error) {
    ...
    <div className="min-h-screen bg-base-200">
      ...
      <div className="max-w-4xl mx-auto p-4 mt-6">
        <div className="mb-6">
          ...
          <h1 className="text-3xl font-bold text-gray-900">Create New Migraine Entry</h1>
        </div>
